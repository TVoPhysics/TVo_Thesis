%----------------------------------------------------------------
% function [x,y] = VaryMMTT_95MM_wSqz_MMTTon_maxtem4(noplot)
% Matlab function to plot Finesse output data
% Usage: 
%   [x,y] = VaryMMTT_95MM_wSqz_MMTTon_maxtem4    : plots and returns the data
%   [x,y] = VaryMMTT_95MM_wSqz_MMTTon_maxtem4(1) : just returns the data
%           VaryMMTT_95MM_wSqz_MMTTon_maxtem4    : just plots the data
% Created automatically Tue Sep 13 22:23:36 2016
% by Finesse 2.1 (2.1-2-gb87c29b), 16.05.2016
%----------------------------------------------------------------
function [x,y] = VaryMMTT_95MM_wSqz_MMTTon_maxtem4(noplot)

data = load('VaryMMTT_95MM_wSqz_MMTTon_maxtem4.out');
[rows,cols]=size(data);
x=data(:,1);
y=data(:,2:cols);
mytitle='VaryMMTT\_95MM\_wSqz\_MMTTon\_maxtem4                Tue Sep 13 22:23:36 2016';
if (nargin==0)

figure('name','VaryMMTT_95MM_wSqz_MMTTon_maxtem4');
