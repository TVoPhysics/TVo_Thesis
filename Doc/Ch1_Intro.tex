\chapter{Introduction}\label{intro}
	...
	\begin{figure}[ht]
		...
		{\textbf{Euler angles of gravitational radiation to the detector frame.}  The $\hat{x}$ and $\hat{y}$ coordinates line up with the arms of the interferometer. }
		\label{fig:euler}
	\end{figure}
