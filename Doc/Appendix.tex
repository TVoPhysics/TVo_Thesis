...
\begin{appendices}
	...
	\end{split}
	\end{equation}
	Plugging in limits for the equation where $r_0$ is the boundary between the inner and outer segments,
	\begin{equation}
	\text{P}_{in} = \text{Power} \biggr\rvert_0^{r_0} = \abs{A_{00}}^2 \frac{\pi \omega^2}{2} [1 - e^{\frac{-2r_0^2}{\omega^2}}]
	\end{equation}
	\begin{equation}
	\text{P}_{out} = \text{Power} \biggr\rvert_{r_0}^{\infty} = \abs{A_{00}}^2 \frac{\pi \omega^2}{2} [e^{\frac{-2r_0^2}{\omega^2}}]
	\end{equation}
	...
	\begin{equation}
	\begin{aligned}
	\frac{\partial \text{S}_{WID}}{\partial \omega} &\approx \frac{8 r_0^2}{\omega^2} \bigg(1-\frac{2 r_0^2}{\omega^2}\bigg) = 0 \\
	\Rightarrow	\omega &= \sqrt{2} r_0
	\end{aligned}
	\end{equation}
